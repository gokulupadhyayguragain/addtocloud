...
export default function BusinessIntelligencePage() {
  return (
    <>
      <Head>
        <title>Business Intelligence - AddToCloud Enterprise</title>
        <meta name="description" content="Advanced analytics and visualization tools for data-driven insights" />
        <meta name="keywords" content="cloud, analytics, business-intelligence, enterprise, nepal, addtocloud" />
      </Head>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-slate-800/50 p-8 rounded-lg border border-slate-700">
                ...
                <ul className="text-slate-300 space-y-3 mb-8">
                  <li>✓ Basic business-intelligence features</li>
                  <li>✓ 24/7 support</li>
              ...
              <div className="bg-slate-800/50 p-8 rounded-lg border border-slate-700">
                ...
                <ul className="text-slate-300 space-y-3 mb-8">
                  <li>✓ Full business-intelligence suite</li>
