...
export default function SecurityHardeningPage() {
  return (
    <>
      <Head>
        <title>Security Hardening - AddToCloud Enterprise</title>
        <meta name="description" content="Professional Security Hardening service with enterprise-grade security, scalability, and Nepal market optimization" />
        <meta name="keywords" content="cloud, database, security-hardening, enterprise, nepal, addtocloud" />
      </Head>
        ...
        <section className="pt-24 pb-12 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-blue-200 mb-8 max-w-3xl mx-auto">
              Professional Security Hardening service with enterprise-grade security, scalability, and Nepal market optimization
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-slate-800/50 p-8 rounded-lg border border-slate-700">
                ...
                <ul className="text-slate-300 space-y-3 mb-8">
                  <li>✓ Basic security-hardening features</li>
                  <li>✓ 24/7 support</li>
              ...
              <div className="bg-gradient-to-br from-blue-600 to-purple-600 p-8 rounded-lg transform scale-105">
                ...
                <ul className="text-blue-100 space-y-3 mb-8">
                  <li>✓ Advanced security-hardening features</li>
              ...
              <div className="bg-slate-800/50 p-8 rounded-lg border border-slate-700">
                ...
                <ul className="text-slate-300 space-y-3 mb-8">
                  <li>✓ Full security-hardening suite</li>
